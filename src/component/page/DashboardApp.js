  ...
  return (
    <>
      ...
      <Grid
        ...
        style={{}}
      >
        <Grid container    style={{ width: "90%", margin: "2rem auto", padding: "2rem auto",  backgroundColor: "#303550",borderRadius:"10px",padding:"1rem" }}>
      ...
      <Grid
        ...
        style={{}}
      >
      <Grid container    style={{ width: "90%", margin: "2rem auto", padding: "2rem auto",borderRadius:"10px",padding:"1rem" }}>
      <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
      <Box style={{fontSize:"4rem",color:"white",marginTop:"4rem",fontWeight:"800"}}>OUR ESPORTS TRACK RECORD</Box>
      </Grid>
      
      </Grid>
      <Grid container  style={{ width: "90%", margin: "2rem auto", padding: "2rem auto",borderRadius:"10px",padding:"1rem" }}>
      <Grid item xl={2} lg={2} md={2} sm={6} xs={12}>
      <Box style={{backgroundColor:"#1D1E20",padding:"2rem",borderRadius:"1rem",marginRight:"2rem"}}>
      <span>
      ...
      <svg width="43px" height="31px" viewBox="0 0 43 31" version="1.1" xmlns="http://www.w3.org/2000/svg" >
          ...
          <defs>
              <linearGradient x1="14.3512173%" y1="41.2001182%" x2="50%" y2="75.98702%" id="linearGradient-1">
      ...
      <br/><br/> <br/><br/>
      <br/>      <span style={{color:"white",fontSize:"2rem",fontStyle:"italic"}}>+ 12,000</span><br/>
      <span style={{color:"#dfdfdf",fontSize:"1.8rem"}}>GAMES</span>
      </Box>
      </Grid>
      <Grid item xl={2} lg={2} md={2} sm={6} xs={12}>
      <Box style={{backgroundColor:"#1D1E20",padding:"2rem",borderRadius:"1rem",marginRight:"2rem"}}>
      ...
      <br/><br/> <br/><br/>
      <br/>      <span style={{color:"white",fontSize:"2rem",fontStyle:"italic"}}>+ 447,799</span><br/>
      <span style={{color:"#dfdfdf",fontSize:"1.8rem"}}>PLAYERS</span>
      </Box>
      </Grid>
      <Grid item xl={2} lg={2} md={2} sm={6} xs={12}>
      <Box style={{backgroundColor:"#1D1E20",padding:"2rem",borderRadius:"1rem",marginRight:"2rem"}}>
...
<svg width="51px" height="32px" viewBox="0 0 51 32" version="1.1" xmlns="http://www.w3.org/2000/svg" >
    ...
    <g id="Web2020" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <br/><br/> <br/><br/>
      <br/>      <span style={{color:"white",fontSize:"2rem",fontStyle:"italic"}}>+ 151,904</span><br/>
      <span style={{color:"#dfdfdf",fontSize:"1.8rem"}}>TEAMS</span>
      </Box>
      </Grid>
      <Grid item xl={2} lg={2} md={2} sm={6} xs={12}>
      <Box style={{backgroundColor:"#1D1E20",padding:"2rem",borderRadius:"1rem",marginRight:"2rem"}}>
      ...
      <br/><br/> <br/><br/>
      <br/>      <span style={{color:"white",fontSize:"2rem",fontStyle:"italic"}}>+ 103</span><br/>
      <span style={{color:"#dfdfdf",fontSize:"1.8rem"}}>CHAMPIONS</span>
      </Box>
      </Grid>
      <Grid item xl={2} lg={2} md={2} sm={6} xs={12}>
      <Box style={{backgroundColor:"#1D1E20",padding:"2rem",borderRadius:"1rem",marginRight:"2rem"}}>
      ...
      <br/><br/> <br/><br/>
      <br/>      <span style={{color:"white",fontSize:"2rem",fontStyle:"italic"}}>+ 10,000,000SAR</span><br/>
      <span style={{color:"#dfdfdf",fontSize:"1.8rem"}}>WORTH OF PRIZES</span>
      </Box>
      </Grid>
